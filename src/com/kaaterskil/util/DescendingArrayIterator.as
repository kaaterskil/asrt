...
package com.kaaterskil.util {
	...
	/**
	 * An array iterator whose pointer begins at the last element.
	 *
	 * @author Blair Caple
	 * @version $Id: $
	 */
	public class DescendingArrayIterator implements Iterator {
		private var index : int;
		private var data : Array;
		
		function DescendingArrayIterator(data : Array) {
			index = data.length - 1;
			this.data = data;
		}
